...
export const routes = [
  {
    ...
    jsonLd: {
      ...
      name: 'Sharayah Hefner',
      description: 'Frontend UX Engineer and Design Engineer specializing in React, Next.js, e-commerce, design systems, interaction design, and polished production experiences.',
      url: 'https://sharayahdesigner.com/',
      mainEntity: {
        '@type': 'Person',
        name: 'Sharayah Hefner',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      url: 'https://sharayahdesigner.com/resume',
      mainEntity: {
        '@type': 'Person',
        name: 'Sharayah Hefner',
        jobTitle: 'Frontend UX Engineer & Design Engineer',
      ...
      subjectOf: {
        ...
        name: 'Sharayah Hefner Résumé',
        url: 'https://sharayahdesigner.com/Sharayah_Hefner_Frontend_UX_Engineer_Resume.pdf',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      description: 'See how Sharayah Hefner approached the UX design and frontend engineering of Cabana Filters.',
      image: 'https://sharayahdesigner.com/images/cabana.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/cabana-filters',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      description: 'See how Sharayah Hefner approached the UX design and frontend engineering of StudioPlayer.',
      image: 'https://sharayahdesigner.com/images/studioPlayerUXUI.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/studioplayer',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      description: 'See how Sharayah Hefner approached the UX design and frontend engineering of My Logo Mat.',
      image: 'https://sharayahdesigner.com/images/logomat.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/my-logo-mat',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      description: 'See how Sharayah Hefner approached the UX design and frontend engineering of Concrete Connections NWA.',
      image: 'https://sharayahdesigner.com/images/shareImage.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/concrete-connections-nwa',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      description: 'See how Sharayah Hefner approached the product design and frontend engineering of Barnes Hauling & Disposal.',
      image: 'https://sharayahdesigner.com/images/bhanddisposal.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/barnes-hauling',
  ...
  },
  {
    ...
    jsonLd: {
      ...
      image: 'https://sharayahdesigner.com/images/shareImage.webp',
      author: { '@type': 'Person', name: 'Sharayah Hefner', url: 'https://sharayahdesigner.com' },
      mainEntityOfPage: 'https://sharayahdesigner.com/work/atlas-league',
